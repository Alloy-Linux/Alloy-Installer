...
def users_slide(content_area, go_to_slide, app):
    ...
    confirm_entry.set_placeholder_text("Re-enter password")
    ...
    show_user_pw_check = Gtk.CheckButton(label="Show user password")
    def on_toggle_user_password(button):
        is_visible = button.get_active()
        password_entry.set_visibility(is_visible)
        confirm_entry.set_visibility(is_visible)
    show_user_pw_check.connect("toggled", on_toggle_user_password)
    main_box.append(show_user_pw_check)
    ...
    root_pw_entry = Gtk.Entry()
    root_pw_entry.set_placeholder_text("Enter root password")
    root_pw_entry.set_visibility(False)
    ...
    root_confirm_entry = Gtk.Entry()
    root_confirm_entry.set_placeholder_text("Re-enter root password")
    root_confirm_entry.set_visibility(False)
    ...
    show_root_pw_check = Gtk.CheckButton(label="Show root password")
    def on_toggle_root_password(button):
        is_visible = button.get_active()
        root_pw_entry.set_visibility(is_visible)
        root_confirm_entry.set_visibility(is_visible)
    show_root_pw_check.connect("toggled", on_toggle_root_password)
    main_box.append(show_root_pw_check)
    ...
    def on_same_pw_toggled(button):
        ...
        if active:
            ...
            show_root_pw_check.set_sensitive(False)
            ...
            show_root_pw_check.set_sensitive(True)
            root_match_label.set_text("")
